        ...
        <div class="widget-content" >
          ...
          <?php
            if(isset($_POST['tambah_menu'])){
              ...
              //echo "<br></br>";
              $query_tambah_masakan = "insert into masakan values ('','$nama_masakan','$harga','$stok','$status_masakan','$gambar')";
            ...
            if(isset($_POST['ubah_menu'])){
              ...
              $query_ubah_masakan = "update masakan set nama_masakan = '$nama_masakan', harga = '$harga', stok = '$stok', status_masakan = '$status_masakan' where id_masakan = '$id_masakan'";;
